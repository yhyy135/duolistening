...
| `player.tsx`        | The lyrics view: rAF sweep, follow-mode scroll, the drawn transport, ask-AI, and the translation window that follows playback |
