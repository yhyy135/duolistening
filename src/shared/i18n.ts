...
const en = {
  ...
  "library.needsSettings": "Set up the models and the proxy first.",
...
const STRINGS: Record<LanguageCode, Record<StringKey, string>> = {
  ...
  "zh-CN": {
    ...
    "library.needsSettings": "请先在设置里配置模型和代理。",
  ...
  "zh-TW": {
    ...
    "library.needsSettings": "請先在設定裡配置模型和代理。",
  ...
  ja: {
    ...
    "library.needsSettings": "先に設定でモデルとプロキシを登録してください。",
  ...
  ko: {
    ...
    "library.needsSettings": "먼저 설정에서 모델과 프록시를 구성하세요.",
  ...
  es: {
    ...
    "library.needsSettings": "Configura primero los modelos y el proxy.",
  ...
  fr: {
    ...
    "library.needsSettings": "Configurez d'abord les modèles et le proxy.",
  ...
  de: {
    ...
    "library.needsSettings": "Richte zuerst die Modelle und den Proxy ein.",
